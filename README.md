...
1.  修改数据库用户视图 执行**create_activiti_view.sql**文件
<table>
    <tr>
        <td><img src="http://img.matosiki.site/image/temp/model.png"/></td>
        <td><img src="http://img.matosiki.site/image/temp/proccess.png"/></td>
    </tr>
    <tr>
            <td><img src="http://img.matosiki.site/image/temp/task_add_model.png"/></td>
            <td><img src="http://img.matosiki.site/image/temp/task.png"/></td>
    </tr>
</table>
