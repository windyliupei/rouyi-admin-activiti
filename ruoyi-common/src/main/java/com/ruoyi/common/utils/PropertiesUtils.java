...
public final class PropertiesUtils {
    ...
    public static Map loadClassPathProperties(String filename) {
        InputStream in = Global.class.getClassLoader().getResourceAsStream(filename);
        if (in==null) {
            return new HashMap(0);
        }
        return PropertiesUtils.properties(in);
    }
