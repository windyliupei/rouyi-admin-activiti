...
public class Global {
    ...
    public static String getConfig(String key) {
        ...
        if (value == null) {
            ...
            try {
                ...
                String v = String.valueOf(YamlUtil.getProperty(yamlMap, key));
                map.put(key, v != null ? v : StringUtils.EMPTY);
                map.putAll(PropertiesUtils.loadClassPathProperties("config1.properties"));
                value = map.get(key);
    ...
    public static String getSpringProfiles() {
        return StringUtils.nvl(getConfig("spring.profiles.active"), "dev");
    }
